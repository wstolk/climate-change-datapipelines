...
datasets = [
    {
        ...
        "s3_filename": "global_temperature.csv",
        ...
        "s3_filename": "sea_level_change.csv",
        ...
        "s3_filename": "population_growth.csv",
...
def create_dag(id, url, resource, headers, s3_filename, staging_table, prod_table, prod_columns, insert_query):
    dag = DAG(dag_id=id,
